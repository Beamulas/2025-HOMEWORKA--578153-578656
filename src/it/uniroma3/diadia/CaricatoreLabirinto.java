...
public class CaricatoreLabirinto {
	...
	private Stanza stanzaIniziale; //per la stanza da cui inizio
	private Stanza stanzaVincente; //per la stanza che mi fa vincere


	//costruttore, contiene l'exception visto che si tratta di un file
